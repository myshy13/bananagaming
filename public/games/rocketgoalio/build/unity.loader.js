          ...
          return void 0 === e
            ...
            : e.read().then(function (e) {
                if (e.done) {
                  ...
                  for (var t = new Uint8Array(f), n = (t.set(d, 0), h), r = 0; r < u.length; ++r)
      ...
      (C.prototype.cleanUpCache = function () {
        ...
        return this.getMetaDataEntries().then(function (e) {
          for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
            t[a].version == u.productVersion ? o.push(t[a]) : (r.push(t[a]), (n -= t[a].size))
          o.sort(function (e, t) {
              ...
              ;((i.prototype.push = function (e, t) {
                ...
                do {
                  ...
                  (!s.next_out ||
                    (0 !== s.avail_out &&
                      n !== m.Z_STREAM_END &&
                      (0 !== s.avail_in || (r !== m.Z_FINISH && r !== m.Z_SYNC_FLUSH))) ||
            ...
            "zlib/inflate.js": function (e, t, n) {
                ...
                return (
                  ...
                  r >= e.wsize
                    ...
                    : (r < (o = e.wsize - e.wnext) && (o = r),
                      ...
                      (r -= o)
                        ? (T.arraySet(e.window, t, n - r, r, 0), (e.wnext = r), (e.whave = e.wsize))
                        : ((e.wnext += o),
              ...
              ;((n.inflateReset = s),
                    ...
                    switch (n.mode) {
                          ...
                          switch (((n.last = 1 & c), --d, 3 & (c >>>= 1))) {
                            ...
                            case 1:
                              var B,
                                ...
                                A = n
                              if (Z) {
                                for (F = new T.Buf32(512), H = new T.Buf32(32), B = 0; B < 144; )
                                  A.lens[B++] = 8
                                for (; B < 256; ) A.lens[B++] = 9
                                for (; B < 280; ) A.lens[B++] = 7
                                for (; B < 288; ) A.lens[B++] = 8
                                for (
                                  L(1, A.lens, 0, 288, F, 0, A.work, { bits: 9 }), B = 0;
                                  B < 32;
                                )
                                  A.lens[B++] = 5
                                ;(L(2, A.lens, 0, 32, H, 0, A.work, { bits: 5 }), (Z = !1))
                              }
                              if (
                                ((A.lencode = F),
                                (A.lenbits = 9),
                      ...
                      case 19:
                        for (; n.have < n.nlen + n.ndist; ) {
                          for (
                            ;
                            (g = ((E = n.lencode[c & ((1 << n.lenbits) - 1)]) >>> 16) & 255),
                              (w = 65535 & E),
                              !((p = E >>> 24) <= d);
                          ) {
                            if (0 === s) break e
                      ...
                      case 23:
                        for (
                          ;
                          (g = ((E = n.distcode[c & ((1 << n.distbits) - 1)]) >>> 16) & 255),
                            (w = 65535 & E),
                            !((p = E >>> 24) <= d);
                        ) {
                          if (0 === s) break e
                ...
                (n.inflateEnd = function (e) {
                  var t
                  return e && e.state
                    ? ((t = e.state).window && (t.window = null), (e.state = null), z)
                    : O
                }),
                    ...
                    if (((k >>>= r = n >>> 24), (_ -= r), 0 == (r = (n >>> 16) & 255)))
                      ...
                      for (
                        ...
                        if (((k >>>= r), (_ -= r), (r = f - m) < a)) {
                          ...
                          for (; 2 < o; )
                            ((h[f++] = s[i++]), (h[f++] = s[i++]), (h[f++] = s[i++]), (o -= 3))
                          o && ((h[f++] = s[i++]), 1 < o && (h[f++] = s[i++]))
                        } else {
                          for (
                            i = f - a;
                            (h[f++] = h[i++]), (h[f++] = h[i++]), (h[f++] = h[i++]), 2 < (o -= 3);
                          );
      ...
      ;(u.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (n += 4; n < o; ) {
            ...
            n += s
            for (var c = 0, d = l.indexOf("/", c) + 1; 0 < d; c = d, d = l.indexOf("/", c) + 1)
