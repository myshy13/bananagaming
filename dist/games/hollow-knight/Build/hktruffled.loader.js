    ...
    if ("symbolsUrl" != e) {
      ...
      ;(t ||
        ...
        "object" != typeof r ||
          ...
          (t.started || ((t.started = !0), (t.lengthComputable = r.lengthComputable)),
          (t.total = r.total),
          (t.loaded = r.loaded),
        ...
        return (
          ...
          fetch(r, n).then(function (r) {
            function n() {
              return "undefined" == typeof a
                ? r.arrayBuffer().then(function (e) {
                    return (
                      t({ type: "progress", total: e.length, loaded: 0, lengthComputable: i }),
                      new Uint8Array(e)
                    )
                  })
            ...
            return (
              ...
              n().then(function (e) {
                return (
                  t({ type: "load", total: e.length, loaded: e.length, lengthComputable: i }),
                  (r.parsedBody = e),
                  r
                )
              })
