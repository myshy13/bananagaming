...
Game.Launch = function () {
  ...
  Game.Timeout = function () {
    ...
    l("javascriptError").innerHTML =
      ...
      (Game.Has("Twin Gates of Transcendence") ? " and generating offline cookies" : "") +
      ".<br><a " +
      Game.clickStr +
  ...
  Game.Init = function () {
    ...
    Game.bakeryNameRefresh = function () {
      ...
      if (name.indexOf("saysopensesame", name.length - "saysopensesame".length) > 0 && !Game.sesame)
        Game.OpenSesame()
        ...
        if (Game.useLocalStorage) {
          ...
          if (str.length < 10) {
            if (Game.prefs.popups)
              Game.Popup("Error while saving.<br>Purchasing an upgrade might fix this.")
            else
              Game.Notify(
                "Saving failed!",
    ...
    Game.crateTooltip = function (me, context) {
      ...
      if (me.type == "upgrade") {
        ...
        if (me.tier != 0 && Game.Has("Label printer"))
          tags.push("Tier : " + Game.Tiers[me.tier].name, Game.Tiers[me.tier].color)
    ...
    Game.costDetails = function (cost) {
      ...
      if (cost > Game.cookies)
        priceInfo += "in " + Game.sayTime(((cost - Game.cookies) / cps + 1) * Game.fps) + "<br>"
    ...
    Game.UpdateLegacyPrompt = function () {
      ...
      var cookiesToNext = Math.floor(
        Game.HowManyCookiesReset(Game.HowMuchPrestige(Game.cookiesReset + Game.cookiesEarned) + 1) -
          Game.cookiesReset -
          Game.cookiesEarned,
      )
    ...
    Game.harvestLumps = function (amount, silent) {
      ...
      if (!silent) {
        ...
        if (total > 0)
          Game.Popup(
            "<small>+" + Beautify(total) + " sugar lump" + (total == 1 ? "" : "s") + "</small>",
      ...
      golden: {
        ...
        popFunc: function (me) {
          ...
          if (popup == "" && buff && buff.name && buff.desc)
            popup = buff.name + '<div style="font-size:65%;">' + buff.desc + "</div>"
          ...
          if (Game.prefs.popups)
            Game.Popup(
              "You found " +
                ...
                Beautify(moni) +
                " cookies." +
                (cookie == "" ? "" : "<br>You are also rewarded with " + cookie + "!"),
            )
          else
            Game.Notify(
              "You found " +
    ...
    Game.ConfirmPrompt = function () {
      if (Game.promptOn && l("promptOption0") && l("promptOption0").style.display != "none")
    ...
    Game.sayTime = function (time, detail) {
      ...
      if (detail == -1) {
        ...
        /*if (time>=Game.fps*60*60*24*30*2 && detail<1) str=Beautify(Math.floor(time/(Game.fps*60*60*24*30)))+' months';
          ...
          str = Beautify(Math.floor(time / (Game.fps * 60 * 60 * 24))) + " days"
        ...
        str +=
          ...
          Game.canLumps()
            ? '</div><div class="subsection">' +
              ...
              (ascensionModeStr != ""
                ? '<div class="listing"><b>Challenge mode :</b>' + ascensionModeStr + "</div>"
                : "") +
              (Game.season != ""
              ...
              (Game.season == "fools"
                ? '<div class="listing"><b>Money made from selling cookies :</b> $' +
                  ...
                  (Game.Objects["Portal"].amount > 0
                    ? '<div class="listing"><b>TV show seasons produced :</b> ' +
                      Beautify(
                        Math.floor(
                          (timeInSeconds / 60 / 60) * (Game.Objects["Portal"].amount * 0.13) + 1,
                        ),
                      ) +
                      "</div>"
                    : "")
                : "") +
              (researchStr != ""
                ? '<div class="listing"><b>Research :</b> ' + researchStr + " remaining</div>"
                : "") +
              (wrathStr != ""
                ? '<div class="listing"><b>Grandmatriarchs status :</b> ' + wrathStr + "</div>"
                : "") +
              (pledgeStr != ""
                ? '<div class="listing"><b>Pledge :</b> ' + pledgeStr + " remaining</div>"
                : "") +
              (Game.wrinklersPopped > 0
              ...
              (santaStr != ""
                ...
                : "") +
              (dragonStr != ""
                ? '<div class="listing"><b>Dragon training :</b></div><div>' + dragonStr + "</div>"
                : "") +
              ""
            : "") +
          ...
          "</div>" +
          (milkStr != ""
            ? '<div class="listing"><b>Milk flavors unlocked :</b></div><div>' + milkStr + "</div>"
            : "") +
    ...
    Game.getNewTicker = function (manual) {
      ...
      if (
        Game.elderWrath > 0 &&
        ((Game.pledges == 0 && Game.resets == 0 && Math.random() < 0.5) || Math.random() < 0.05)
      ) {
        list = []
      ...
      if (
        ...
        if (fortunes.length > 0) {
          ...
          if (me == "fortuneGC")
            me = "Today is your lucky day!" /*<br>Click here for a golden cookie.';*/
            ...
            me =
              ...
              " " +
              Math.floor(Math.random() * 100)
          /*+'<br>Click here to gain one hour of your CpS.'*/ else {
            me =
    ...
    Game.Object = function (
        ...
        return (
          ...
          (me.totalCookies > 0
            ? '<div class="line"></div><div class="data">' +
              ...
              "</b> " +
              (me.storedTotalCps * Game.globalCpsMult == 1 ? "cookie" : "cookies") +
              " per second (<b>" +
              Beautify(
                Game.cookiesPs > 0
                  ? (me.amount > 0
      ...
      this.rebuild = function () {
        ...
        if (Game.isMinigameReady(me) && Game.ascensionMode != 1) {
          ...
          if (!me.onMinigame)
            l("productMinigameButton" + me.id).innerHTML = "View " + me.minigameName
        ...
        this.draw = function () {
          ...
          for (var i = 0; i < len; i++) {
            ...
            if (selected == i && this.name == "Grandma") {
              ...
              var text =
                name + ", age " + Beautify(Math.floor(70 + Math.random() * 30 + years + this.level))
        ...
        if (this.choicesFunction) {
          if (Game.choiceSelectorOn == this.id) {
            ...
            if (choices.length > 0) {
              ...
              var str = ""
              str +=
                '<div class="close" onclick="Game.UpgradesById[' + this.id + '].buy();">x</div>'
              str +=
                "<h3>" +
                this.name +
                "</h3>" +
    ...
    Game.RequiresConfirmation = function (upgrade, prompt) {
      upgrade.clickFunction = function () {
        Game.Prompt(prompt, [
          ["Yes", "Game.UpgradesById[" + upgrade.id + "].buy(1);Game.ClosePrompt();"],
          "No",
        ])
        return false
      }
      ...
      return (
        ...
        (Game.pledges == 0
          ...
          : "You've pledged to the elders <b>" +
            (Game.pledges == 1 ? "once" : Game.pledges == 2 ? "twice" : Game.pledges + " times") +
            "</b>.") +
    ...
    new Game.Upgrade(
      ...
      function () {
        ...
        if (Game.prefs.popups)
          Game.Popup("The chocolate egg bursts into<br>" + Beautify(cookies) + "!")
        else
          Game.Notify(
            "Chocolate egg",
      ...
      Game.Upgrades[slots[i]].descFunc = (function (i) {
        return function () {
          ...
          return (
            ...
            (upgrade.icon[2] ? "background-image:url(" + upgrade.icon[2] + ");" : "") +
            "background-position:" +
            -upgrade.icon[0] * 48 +
            "px " +
            -upgrade.icon[1] * 48 +
    ...
    Game.last.descFunc = function () {
      ...
      return (
        ...
        (choice.icon[2] ? "background-image:url(" + choice.icon[2] + ");" : "") +
        "background-position:" +
        -choice.icon[0] * 48 +
        "px " +
        -choice.icon[1] * 48 +
    ...
    var func = function () {
      ...
      return (
        ...
        (resist > 0 ? "<br><br>Has a <b>" + Beautify(resist) + "%</b> chance to not break." : "")
      )
    }
    ...
    Game.thresholdIcons = [
      ...
      23, 24, 25, 26, 27, 28, 29, 21, 22, 23, 24, 25, 26, 27, 28, 29,
    ]
    ...
    Game.BankAchievement = function (name) {
      ...
      var achiev = new Game.Achievement(
        ...
        [
          ...
          Game.BankAchievements.length > 32 ? 1 : Game.BankAchievements.length > 23 ? 2 : 5,
        ],
      )
    ...
    Game.CpsAchievement = function (name) {
      ...
      var achiev = new Game.Achievement(
        ...
        [
          ...
          Game.CpsAchievements.length > 32 ? 1 : Game.CpsAchievements.length > 23 ? 2 : 5,
        ],
      )
      achiev.threshold = threshold
    ...
    new Game.buffType("everything must go", function (time, pow) {
      return {
        ...
        desc:
          "All buildings are " + pow + "% cheaper for " + Game.sayTime(time * Game.fps, -1) + "!",
        icon: [17, 6],
        time: time * Game.fps,
        add: true,
        power: pow,
    ...
    new Game.buffType("haggler luck", function (time, pow) {
      return {
        name: "Haggler's luck",
        desc:
          "All upgrades are " + pow + "% cheaper for " + Game.sayTime(time * Game.fps, -1) + "!",
        icon: [25, 11],
        time: time * Game.fps,
        power: pow,
        max: true,
    ...
    new Game.buffType("haggler misery", function (time, pow) {
      return {
        ...
        desc:
          "All upgrades are " + pow + "% pricier for " + Game.sayTime(time * Game.fps, -1) + "!",
        icon: [25, 11],
        time: time * Game.fps,
        power: pow,
        max: true,
    ...
    new Game.buffType("pixie misery", function (time, pow) {
      return {
        name: "Nasty goblins",
        desc:
          "All buildings are " + pow + "% pricier for " + Game.sayTime(time * Game.fps, -1) + "!",
        icon: [26, 11],
        time: time * Game.fps,
        power: pow,
        max: true,
    ...
    new Game.buffType("magic adept", function (time, pow) {
      return {
        name: "Magic adept",
        desc:
          "Spells backfire " + pow + " times less for " + Game.sayTime(time * Game.fps, -1) + ".",
        icon: [29, 11],
        time: time * Game.fps,
        power: pow,
        max: true,
    ...
    new Game.buffType("magic inept", function (time, pow) {
      return {
        name: "Magic inept",
        desc:
          "Spells backfire " + pow + " times more for " + Game.sayTime(time * Game.fps, -1) + ".",
        icon: [29, 11],
        time: time * Game.fps,
        power: pow,
        max: true,
      ...
      for (var i in Game.wrinklers) {
        ...
        if (me.hp <= 0.5 && me.phase > 0) {
          ...
          if (me.sucked > 0.5) {
            ...
            Game.Popup(
              '<div style="font-size:80%;">+' + Beautify(me.sucked) + " cookies</div>",
              Game.mouseX,
              Game.mouseY,
            )
    ...
    Game.OpenSesame = function () {
      ...
      str +=
        '<a class="option neato" ' + Game.clickStr + '="Game.SetAllAchievs(1);">All achievs</a><br>'
      str +=
        '<a class="option neato" ' +
        Game.clickStr +
    ...
    Game.ready = 1
    setTimeout(function () {
      if (typeof showAds === "undefined" && (!l("detectAds") || l("detectAds").clientHeight < 1))
        Game.addClass("noAds")
    }, 500)
    l("javascriptError").innerHTML = ""
    l("javascriptError").style.display = "none"
      ...
      if (Game.researchT == 0 && Game.nextResearch) {
        if (!Game.Has(Game.UpgradesById[Game.nextResearch].name)) {
          ...
          if (Game.prefs.popups)
            ...
            Game.Notify(
              "Research complete",
              "You have discovered : <b>" + Game.UpgradesById[Game.nextResearch].name + "</b>.",
