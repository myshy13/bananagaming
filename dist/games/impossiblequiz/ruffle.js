(() => {
  ...
  var e,
    ...
    a = {
      ...
      665(e, n, a) {
        var t =
          ...
          r =
            ...
            function (e, n) {
              for (var a in e)
                "default" === a || Object.prototype.hasOwnProperty.call(n, a) || t(n, e, a);
            };
        (Object.defineProperty(n, "__esModule", { value: !0 }),
          r(a(48), n),
          r(a(269), n),
      ...
      124(e, n, a) {
        e.exports = a.p + "c96929a1581565278a6f.wasm";
      },
      797(e, n, a) {
        e.exports = a.p + "14469a8b6303e2eba21b.wasm";
      },
    },
    t = {};
  function r(e) {
  ...
  ((r.m = a),
    (r.d = (e, n) => {
      for (var a in n)
        r.o(n, a) && !r.o(e, a) && Object.defineProperty(e, a, { enumerable: !0, get: n[a] });
    }),
    (r.f = {}),
    (r.e = (e) => Promise.all(Object.keys(r.f).reduce((n, a) => (r.f[a](e, n), n), []))),
    (r.u = (e) =>
      "core.ruffle." + { 482: "a7a4cf238dfc011fa3f3", 655: "d4a0ae10dec434c7dc6f" }[e] + ".js"),
    (r.g = (function () {
  ...
  const l = {
    versionNumber: "0.2.0-nightly.2026.4.8",
    versionName: "0.2.0-nightly.2026.4.8",
    versionChannel: "nightly",
    buildDate: "2026-04-08T00:15:14.863Z",
    commitHash: "0ec97cb4cca07d090f6d7a8a208ed2d71c8bc6c1",
  };
  var u;
  !(function (e) {
  ...
  class C extends x {
    static supportsValue(e) {
      ...
      if (e instanceof x) return C.supportsValue(e.valueOf());
  ...
  function E(e, n, a) {
    if (a === n) return !0;
    if (a instanceof A && n instanceof A && a.value === n.value) return !0;
    if (n instanceof A && "string" == typeof a) {
      if (a === e.memoizeIntlObject(Intl.PluralRules, n.opts).select(n.value)) return !0;
    }
    return !1;
  }
  function F(e, n, a) {
    return n[a] ? O(e, n[a].value) : (e.reportError(new RangeError("No default")), new S());
  }
  function P(e, n) {
    const a = [],
      t = Object.create(null);
    for (const r of n) "narg" === r.type ? (t[r.name] = q(e, r.value)) : a.push(q(e, r));
  ...
  function q(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new A(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof a) {
            ...
            case "number":
              return new A(a);
            case "object":
              if (C.supportsValue(a)) return new C(a);
            default:
              return (
                e.reportError(new TypeError(`Variable type not supported: $${n}, ${typeof a}`)),
                new S(`$${n}`)
              );
          }
        })(e, n);
      case "mesg":
        return (function (e, { name: n, attr: a }) {
          ...
          if (a) {
            ...
            return r
              ? O(e, r)
              : (e.reportError(new ReferenceError(`Unknown attribute: ${a}`)), new S(`${n}.${a}`));
          }
          if (t.value) return O(e, t.value);
      ...
      case "func":
        return (function (e, { name: n, args: a }) {
          ...
          if (!t)
            return (e.reportError(new ReferenceError(`Unknown function: ${n}()`)), new S(`${n}()`));
      ...
      case "select":
        return (function (e, { selector: n, variants: a, star: t }) {
          ...
          for (const n of a) {
            if (E(e, r, q(e, n.key))) return O(e, n.value);
          }
          return F(e, a, t);
        })(e, n);
      default:
  ...
  function D(e, n) {
    ...
    for (const r of n)
      if ("string" != typeof r) {
        ...
        (t && a.push("\u2068"), a.push(q(e, r).toString(e)), t && a.push("\u2069"));
  ...
  function W(e, n) {
    ...
    if (a instanceof A) return new A(a.valueOf(), { ...a.opts, ...M(n, I) });
    if (a instanceof C) return new A(a.toNumber(), { ...M(n, I) });
  ...
  function L(e, n) {
    ...
    if (a instanceof C || a instanceof A) return new C(a, M(n, T));
  ...
  class U {
    constructor(e, { functions: n, useIsolating: a = !0, transform: t = (e) => e } = {}) {
      ((this._terms = new Map()),
        ...
        (this._functions = { NUMBER: W, DATETIME: L, ...n }),
  ...
  class me {
    constructor(e) {
      ...
      function u(t = [], r) {
        ...
        let l = [];
        for (let e of t)
          (e instanceof pe && (e = e.value.slice(0, e.value.length - r)), e && l.push(e));
        return l;
      }
      function c() {
        r(re, SyntaxError);
  ...
  function Re() {
    (("function" == typeof Array.prototype.reduce && je(Array.prototype.reduce)) ||
      ...
      ("function" == typeof Window && je(Window)) ||
        ("function" == typeof window.constructor &&
          je(window.constructor) &&
  ...
  function Ae(e, n) {
    const a = ke(),
      t = we(navigator.languages, Object.keys(xe), { defaultLocale: "en-US" });
    for (const a in t) {
      const r = Se(t[a], e, n);
      if (r) return r;
    }
              ...
              children: (0, R.jsx)("div", {
                ...
                children: (0, R.jsxs)("svg", {
                  ...
                  children: [
                    ...
                    (0, R.jsx)("use", { xmlns: "http://www.w3.org/2000/svg", href: "#b" }),
                  ],
                }),
              }),
            }),
            ...
            children: (0, R.jsxs)("div", {
              ...
              children: [
                ...
                (0, R.jsx)("label", {
                  id: "volume-mute",
                  for: "mute-checkbox",
                  title: Ae("volume-controls-unmute"),
                }),
                (0, R.jsx)("label", {
                  id: "volume-min",
                  for: "mute-checkbox",
                  title: Ae("volume-controls-mute"),
                }),
                (0, R.jsx)("label", {
                  id: "volume-mid",
                  for: "mute-checkbox",
      ...
      (0, R.jsx)(function () {
        return (0, R.jsx)("div", {
          ...
          children: (0, R.jsxs)("div", {
            ...
            children: [
              (0, R.jsx)("span", { class: "close-modal" }),
              (0, R.jsx)("h2", { children: Ae("clipboard-message-title") }),
              (0, R.jsx)("p", { id: "clipboard-modal-description" }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ee, "+C"] }),
                  (0, R.jsx)("span", { children: Ae("clipboard-message-copy") }),
                ],
              }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ee, "+X"] }),
                  (0, R.jsx)("span", { children: Ae("clipboard-message-cut") }),
                ],
              }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ee, "+V"] }),
                  (0, R.jsx)("span", { children: Ae("clipboard-message-paste") }),
                ],
              }),
            ],
          }),
  ...
  const Pe = "application/x-shockwave-flash",
    qe = "application/futuresplash",
    De = "application/x-shockwave-flash2-preview",
    Oe = "application/vnd.adobe.flash.movie";
  function $e(e, n) {
    const a = (function (e) {
      let n = "";
      try {
  ...
  const Ve = {
    OpenDemo: { type: "open_link", url: We + "/demo", label: Ae("ruffle-demo") },
    DownloadDesktop: {
      type: "open_link",
      url: We + "/downloads#desktop-app",
      label: Ae("ruffle-desktop"),
    },
    UpdateRuffle: { type: "open_link", url: We + "/downloads", label: Ae("update-ruffle") },
    ...
    const r = a.join(""),
      { body: o, actions: i } = (function (e) {
        if (e instanceof Te)
          return e.swfUrl && !e.swfUrl.protocol.includes("http")
            ? { body: Ce("error-file-protocol"), actions: [Ve.OpenDemo, Ve.DownloadDesktop] }
            : window.location.origin === e.swfUrl?.origin ||
                e.statusNotOk ||
                window.location.protocol.includes("extension")
              ? { body: Ce("error-swf-fetch"), actions: [Ve.ShowDetails] }
              : {
                  body: Ce("error-swf-cors"),
                  actions: [Ve.openWiki("Using-Ruffle#configure-cors-header"), Ve.ShowDetails],
                };
        if (e instanceof Le) return { body: Ce("error-invalid-swf"), actions: [Ve.ShowDetails] };
        if (e instanceof Ne) {
          if ("file:" === window.location.protocol)
            return { body: Ce("error-file-protocol"), actions: [Ve.OpenDemo, Ve.DownloadDesktop] };
          ...
          if (
            ...
            return { body: Ce("error-wasm-download"), actions: [Ve.ShowDetails] };
          if ("TypeError" === e.cause.name) {
            const e = Ce("error-javascript-conflict");
            return (
              Be() &&
                e.appendChild(Ce("error-javascript-conflict-outdated", { buildDate: l.buildDate })),
        ...
        return e instanceof Ue
          ...
          : {
              body: Ce("error-unknown", { buildDate: l.buildDate, outdated: String(Be) }),
      ...
      u = () => {
        (s.current.classList.add("details"),
          s.current.replaceChildren((0, R.jsx)("textarea", { readOnly: !0, children: r })));
      };
    ((e.textContent = ""),
      e.appendChild(
        (0, R.jsxs)("div", {
          id: "panic",
          children: [
            (0, R.jsx)("div", { id: "panic-title", children: Ae("panic-title") }),
                    ...
                    if ("show_details" === e.type) {
                      ...
                      return (0, R.jsx)("li", {
                        children: (0, R.jsx)("a", {
                          ...
                          onClick: e,
                          children: Ae("view-error-details"),
                        }),
                      });
                    }
                    if ("open_link" === e.type)
  ...
  class un {
    constructor(e, n, a) {
      ...
      t &&
        ...
        (t.innerText = Ae("save-backup-all")));
      const r = this.unmuteOverlay.querySelector("#unmute-overlay-svg");
      if (r) {
        r.querySelector("#unmute-text").textContent = Ae("click-to-unmute");
      }
      ...
      (this.contextMenuElement.addEventListener("contextmenu", o),
        ...
        (this.contextMenuElement.dir = (function () {
          ...
          if ("object" == typeof n && "direction" in n && "string" == typeof n.direction)
    ...
    setupPauseOnTabHidden() {
      document.addEventListener(
        ...
        () => {
          this.instance &&
            (document.hidden &&
              ((this.lastActivePlayingState = this.instance.is_playing()), this.instance.pause()),
    ...
    async reloadWithCanvasRenderer() {
      if (this.loadedConfig && this.loadedConfig.preferredRenderer !== h.Canvas) {
        ...
        if (!this.loadedConfig) throw new Error("Cannot reload if load wasn't first called");
        this.panic(new Error(Ae("error-canvas-reload")));
      }
    }
    async load(e, n = !1) {
      if (
        ((e = this.checkOptions(e)), this.element.isConnected && !this.isUnusedFallbackObject())
      ) {
        if (!pn(this.element))
          try {
            ((this.loadedConfig = {
    ...
    confirmReloadSave(e, n, a) {
      if (gn(n) && localStorage[e]) {
        if (!a) {
          if (!confirm(Ae("save-delete-prompt"))) return;
        }
        ...
        if (t.includes(o) && e.startsWith(r)) {
          return void (
            confirm(Ae("save-reload-prompt", { action: a ? "replace" : "delete" })) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      ((e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          a &&
            t &&
            gn(t) &&
            e.appendChild((0, R.jsx)(this.SaveRow, { rowKey: n, solName: a, solData: t }));
        }));
    }
    async backupSaves() {
    ...
    virtualKeyboardInput() {
      ...
      for (const e of n)
        for (const n of ["keydown", "keyup"])
          this.element.dispatchEvent(new KeyboardEvent(n, { key: e, bubbles: !0 }));
      e.value = "";
    }
    openVirtualKeyboard() {
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({
                text: Ae("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : n.push({
                text: Ae("context-menu-enter-fullscreen"),
                onClick: async () => this.setFullscreen(!0),
              })),
        n.push({
          text: Ae("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (a(),
          n.push({ text: Ae("context-menu-download-swf"), onClick: this.downloadSwf.bind(this) })),
        navigator.clipboard &&
          window.isSecureContext &&
          n.push({
            text: Ae("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          n.push({
            text: Ae("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        a(),
        n.push({
          text: Ae("context-menu-about-ruffle", {
            flavor: Ie ? "extension" : "",
      ...
      for (const e of this.contextMenuItems())
        if (null === e)
          this.contextMenuElement.appendChild(
            (0, R.jsx)("li", { class: "menu-separator", children: (0, R.jsx)("hr", {}) }),
          );
        else {
    ...
    panic(e) {
      ...
      const n = e;
      if (e instanceof Error && ("AbortError" === e.name || e.message.includes("AbortError")))
        return;
      if (e instanceof Ne) {
    ...
    displayRootMovieDownloadFailedMessage(e, n) {
      ...
      if (a && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const a = n.includes("HTTP Status is not OK:"),
          t = e ? new Le(this.swfUrl) : new Te(this.swfUrl, a);
        this.panic(t);
      }
    }
    displayMessageOrElement(e, n) {
      const a = e instanceof HTMLDivElement ? e : (0, R.jsx)("p", { children: e }),
        t = n
          ? null
          : (0, R.jsx)("div", {
              children: (0, R.jsx)("button", { id: "continue-btn", children: Ae("continue") }),
            }),
        r = (0, R.jsx)("div", {
          id: "message-overlay",
          children: (0, R.jsxs)("div", { class: "message", children: [a, t] }),
        });
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = Ae("clipboard-message-description", {
  ...
  class Rn {
    ...
    addFSCommandHandler(e) {
      jn(this, kn, "f").addFSCommandHandler(e);
    }
    get readyState() {
      return jn(this, kn, "f")._readyState;
    }
    get metadata() {
      return jn(this, kn, "f").metadata;
    }
    get loadedConfig() {
      return jn(this, kn, "f").loadedConfig ?? null;
    }
    async reload() {
      await jn(this, kn, "f").reload();
    }
    async load(e, n = !1) {
      await jn(this, kn, "f").load(e, n);
    }
    resume() {
      jn(this, kn, "f").play();
    }
    get isPlaying() {
      return jn(this, kn, "f").isPlaying;
    }
    get volume() {
      return jn(this, kn, "f").volume;
    }
    set volume(e) {
      jn(this, kn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return jn(this, kn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return jn(this, kn, "f").isFullscreen;
    }
    setFullscreen(e) {
      jn(this, kn, "f").setFullscreen(e);
    }
    requestFullscreen() {
      jn(this, kn, "f").enterFullscreen();
    }
    exitFullscreen() {
      jn(this, kn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await jn(this, kn, "f").downloadSwf();
    }
    displayMessage(e) {
      jn(this, kn, "f").displayMessage(e);
    }
    suspend() {
      jn(this, kn, "f").pause();
    }
    ...
    set traceObserver(e) {
      jn(this, kn, "f").traceObserver = e;
    }
    get config() {
      return jn(this, kn, "f").config;
    }
    set config(e) {
      jn(this, kn, "f").config = e;
    }
    callExternalInterface(e, ...n) {
      return jn(this, kn, "f").callExternalInterface(e, n);
    }
  }
  kn = new WeakMap();
  var zn,
  ...
  class Cn extends HTMLElement {
    ...
    constructor() {
      (super(),
        ...
        Sn(this, zn, "f").addFSCommandHandler((e, n) => {
          Sn(this, xn, "f")?.call(this, e, n);
        }));
    }
    ruffle(e) {
      if (1 === (e ?? 1)) return new Rn(Sn(this, zn, "f"));
    ...
    attributeChangedCallback(e, n, a) {
      Cn.observedAttributes.includes(e) && Sn(this, zn, "f").updateStyles();
    }
  ...
  class Fn extends Cn {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !pn(e) && (fn(n) ? (mn(e, "src"), !1) : $e(n, a));
    }
  ...
  class qn extends Cn {
    ...
    connectedCallback() {
      (super.connectedCallback(), (this.params = Pn(this)));
      let e = null;
      if (
  ...
  class _n {
    ...
    install(e) {
      const n = new Bn(e),
        a = Un(this, Dn, "f").length;
      (Un(this, Dn, "f").push(n),
        (Un(this, On, "f")[e.type] = n),
    ...
    namedItem(e) {
      return Un(this, On, "f")[e];
    }
    get length() {
      return Un(this, Dn, "f").length;
    }
    [((Dn = new WeakMap()), (On = new WeakMap()), Symbol.iterator)]() {
  ...
  class Bn {
    constructor(e) {
      ($n.set(this, void 0), Nn(this, $n, e, "f"));
    }
    get type() {
      return Un(this, $n, "f").type;
    }
    get description() {
      return Un(this, $n, "f").description;
    }
    get suffixes() {
      return Un(this, $n, "f").suffixes;
    }
    get enabledPlugin() {
      return Un(this, $n, "f").enabledPlugin;
    }
    get [(($n = new WeakMap()), Symbol.toStringTag)]() {
      return "MimeType";
    }
  }
  class Vn extends _n {
    ...
    get [((Mn = new WeakMap()), (In = new WeakMap()), (Wn = new WeakMap()), Symbol.toStringTag)]() {
      return "Plugin";
    }
  }
  class Jn {
    constructor(e) {
      (Tn.set(this, void 0), Ln.set(this, void 0), Nn(this, Tn, [], "f"), Nn(this, Ln, {}, "f"));
      for (let n = 0; n < e.length; n++) this.install(e[n]);
    }
    install(e) {
      const n = Un(this, Tn, "f").length;
      (Un(this, Tn, "f").push(e),
    ...
    item(e) {
      return Un(this, Tn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Un(this, Ln, "f")[e];
    }
    refresh() {}
    [((Tn = new WeakMap()), (Ln = new WeakMap()), Symbol.iterator)]() {
      return Un(this, Tn, "f")[Symbol.iterator]();
    }
    get [Symbol.toStringTag]() {
      return "PluginArray";
    }
    get length() {
      return Un(this, Tn, "f").length;
    }
  }
  const Hn = new Vn("Shockwave Flash", "Shockwave Flash 32.0 r0", "ruffle.js");
  (Hn.install({ type: qe, description: "Shockwave Flash", suffixes: "spl", enabledPlugin: Hn }),
    Hn.install({ type: Pe, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Hn }),
    Hn.install({ type: De, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Hn }),
    Hn.install({ type: Oe, description: "Shockwave Flash", suffixes: "swf", enabledPlugin: Hn }));
